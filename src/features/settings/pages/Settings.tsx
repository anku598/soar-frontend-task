...
export function Settings() {
  const tabTriggerStyles =
    'text-[#718EBF] text-[16px] data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary border-b-2 border-transparent data-[state=active]:shadow-none rounded-none'
